Let's use our newfound knowledge of JavaScript loops to create a program that converts an integer into its equivalent [binary number](https://en.wikipedia.org/wiki/Binary_number).
